...
in (yosys.override { inherit abc-verifier; }).overrideAttrs (final: prev: {
  ...
  src = fetchFromGitHub {
    owner = "YosysHQ";
    repo = "yosys";
    rev = "596da3f2a64905237a013746e506bbfc16b8ccec";
    hash = "sha256-1rO7gKf8RGtlsOVs6SfSiq7BkFMgQLjlhTWCAydtl4E=";
  };
  ...
  passthru.updateScript = writeShellScript "update-yosys-unstable" ''
    ...
    ${nix-update}/bin/nix-update --flake yosys-unstable.abc-verifier --version "$ABCREV"
  '';
