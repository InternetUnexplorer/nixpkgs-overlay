{ lib, stdenv, fetchFromGitHub, fetchpatch, meson, ninja, pkg-config, itstool
, python3, libxml2, desktop-file-utils, wrapGAppsHook, gst_all_1, pipewire, gtk3
, glib, glibmm, gtkmm3, lilv, lv2, serd, sord, sratom, libbs2b, libsamplerate
...
in stdenv.mkDerivation rec {
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://github.com/wwmm/pulseeffects/commit/ab7354a6850d23840b4c9af212dbebf4f31a562f.patch";
  ...
  passthru.exePath = "/bin/pulseeffects";
